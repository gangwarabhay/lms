  ...
  return (
    <div className="w-full">
      ...
      <div className="text-center mt-14 px-4">
        <h1 className="text-[36px] md:text-[47.6px] text-[#01464B] font-semibold">
          1:1 Life Coaching For Executives and CEOs
        </h1>
        <div className="mt-2 mx-auto w-[80%] md:w-[500px] border-b-4 md:border-b-6 border-black border-double"></div>
      </div>

      {/* Main content with text and image */}
      <div className="flex flex-col md:flex-row items-start mt-14 gap-6 px-4 md:px-6">
        {/* Left Text Content */}
        <div className="w-full md:max-w-[700px] text-black text-[16px] md:text-[17px] leading-7 space-y-8 md:space-y-12">
          <p>
        ...
        <img
          src="img.png"
          alt="Coaching"
          className="w-full md:w-[500px] h-auto md:h-[421px] object-cover rounded-md shadow-md"
        />
      </div>

      {/* How Coaching Works Section */}
      <div className="text-3xl text-[#01464B] font-bold bg-sky-50 px-4 md:px-10 py-10 mt-18 mx-4 md:mx-7">
        <h1 className="mt-8 text-[28px] md:text-[40px]">
          How does Life coaching Work?
        </h1>
        <p className="text-justify font-normal mt-8 text-[16px] md:text-[17px]">
        ...
        <p className="text-justify font-normal mt-4 text-[16px] md:text-[17px]">
          I hold you accountable to take actions from that place, in direction
          of your goals and dreams.
        </p>

        {/* Testimonial */}
        <div className="bg-[#F1FDFE] px-4 md:px-6 py-10 text-center text-black mt-6">
          <p className="italic text-base md:text-lg leading-relaxed max-w-full md:max-w-3xl mx-auto font-[20px]">
          ...
          <p className="mt-6 text-[18px] md:text-[20px]">– Sandeep Chopra</p>
          <p className="italic text-sm md:text-base">Entrepreneur London</p>
        </div>

        {/* Subsection */}
        <h1 className="text-[28px] md:text-[40px] text-[#01464B] font-bold mt-8">
          How does life coaching for executives work?
        </h1>
        <p className="font-normal mt-6 mb-8 text-[16px] md:text-[17px] text-justify">
      ...
      <div className="px-4 md:px-10 mt-10">
        <h1 className="text-[28px] md:text-[40px] text-[#01464B] font-bold">
          1:1 Deep Intensive Coaching with me
        </h1>
        <p className="mt-6 text-justify text-[16px] md:text-[17px]">
        ...
        <p className="font-normal mt-6 text-[16px] md:text-[17px] text-justify">
      ...
      <div className="mt-10 px-4 md:px-0">
        <div className="flex flex-col md:flex-row justify-center w-full gap-6 mb-3">
          {/* 3 Months Card */}
          <div className="border p-4 md:p-6 w-full md:w-1/3 shadow-sm">
            <h1 className="text-2xl text-[#01464B] font-bold mb-4">
              3 months coaching programme includes
            </h1>
            <ul className="list-disc list-inside space-y-2 text-[15px] md:text-[17px] text-justify">
              <li>
